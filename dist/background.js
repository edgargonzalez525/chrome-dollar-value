...
function getDollarValue(country) {
    ...
    var url = "https://okapi-currency-exchange-rates-v1.p.rapidapi.com/finance/lookup/currency?currency=USD%2C" + currency + "&value=1";
    ...
    return fetch(myRequest)
        ...
        var selected = response.find(function (item) { return item.currency === currency; });
